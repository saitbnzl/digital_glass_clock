...
import 'digital_glass_clock.dart';
...
void main() {
  ...
  // own clock widget. (Look in digital_glass_clock.dart for more details!)
  runApp(ClockCustomizer((ClockModel model) => DigitalGlassClock(model)));
}
